...
!  in kx,ky,z,v,m (   -nx:nx,0:global_ny,-global_nz:global_nz-1,1:2*global_nv,0:global_nm)
  ...
  integer, parameter :: nxw = 336, nyw = 42
  integer, parameter :: nx = 220, global_ny = 27 ! 2/3 de-aliasing rule
...
!--------------------------------------
  ...
  integer, parameter :: nprocw = 4, nprocz = 4, nprocv = 4, nprocm = 2, nprocs = 1
